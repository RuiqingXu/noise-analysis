...
%         .*sin(theta).*(1./(4.*pi));
    F=@(theta,b) 1./2.*(cos(theta).^4.*(P.^2-2.*P+2)+sin(theta).^2.*cos(theta).^2.*P.*(2-P)+sin(theta).^2.*cos(theta).^2.*sqrt(1-P).*(2-P)+sin(theta).^2.*cos(theta).^2.*sqrt(1-P).*P.*exp(-1i.*2.*b)...
        +sin(theta).^2.*cos(theta).^2.*sqrt(1-P).*(2-P)+sin(theta).^2.*cos(theta).^2.*sqrt(1-P).*P.*exp(1i.*2*b)+sin(theta).^2.*cos(2.*theta).*(2.*P-P.^2)+2.*sin(theta).^4).*sin(theta).*(1./(4.*pi));
